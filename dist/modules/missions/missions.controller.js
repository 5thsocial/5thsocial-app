...
const mission_dto_js_1 = require("./mission.dto.js");
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_pipe_js_1.ZodValidationPipe(mission_dto_js_1.MissionCreateDto)),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_js_1.Roles)('user', 'admin'),
    (0, common_1.UsePipes)(new zod_pipe_js_1.ZodValidationPipe(mission_dto_js_1.MissionUpdateDto)),
    __param(0, (0, common_1.Param)('id')),
...
exports.MissionsController = MissionsController = __decorate([
    ...
    __metadata("design:paramtypes", [missions_service_js_1.MissionsService])
], MissionsController);
