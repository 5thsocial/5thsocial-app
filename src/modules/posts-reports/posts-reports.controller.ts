...
import { PostsReportsCreateDto, PostsReportsUpdateDto } from './posts-reports.dto.js';
import { JwtAuthGuard } from '../auth/guards/jwt-auth.guard.js';
import { RolesGuard } from '../auth/guards/roles.guard.js';
import { Roles } from '../auth/decorators/roles.decorator.js';

@ApiTags('posts-reports')
@Controller('posts/:parentId/reports')
@UseGuards(JwtAuthGuard, RolesGuard)
export class PostsReportsController {
  constructor(private readonly svc: PostsReportsService) { }
  ...
  @Post()
  @Roles('user', 'admin')
  @UsePipes(new ZodValidationPipe(PostsReportsCreateDto))
  ...
  @Patch(':id')
  @Roles('admin')
  @UsePipes(new ZodValidationPipe(PostsReportsUpdateDto))
  @ApiBody({ schema: { example: {
  "posts_reports_id": "UUID",
  "parent_id": "POST_UUID",
  "usr_user_id": "UUID",
