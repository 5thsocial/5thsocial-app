...
import { PostsBookmarksCreateDto, PostsBookmarksUpdateDto } from './posts-bookmarks.dto.js';
import { JwtAuthGuard } from '../auth/guards/jwt-auth.guard.js';
import { RolesGuard } from '../auth/guards/roles.guard.js';
import { Roles } from '../auth/decorators/roles.decorator.js';

@ApiTags('posts-bookmarks')
@Controller('posts/:parentId/bookmarks')
@UseGuards(JwtAuthGuard, RolesGuard)
export class PostsBookmarksController {
  constructor(private readonly svc: PostsBookmarksService) { }
  ...
  @Post()
  @Roles('user', 'admin')
  @UsePipes(new ZodValidationPipe(PostsBookmarksCreateDto))
  ...
  @Patch(':id')
  @Roles('user', 'admin')
  @UsePipes(new ZodValidationPipe(PostsBookmarksUpdateDto))
  @ApiBody({ schema: { example: {
  "posts_bookmarks_id": "UUID",
  "parent_id": "POST_UUID",
  "usr_user_id": "UUID"
